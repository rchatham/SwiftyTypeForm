#
#  Be sure to run `pod spec lint SwiftyTypeForm.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Reid Chatham"
  # s.authors            = { "Reid Chatham" => "reid.chatham@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Reid Chatham"
